...
_Generated: 2026-08-21T14:01:45.096Z_
...
Workspace `mcp.json` _(folder: CRMCABANA)_

- **g:\Meu Drive\Codex\CRMCABANA\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Carlos Braga\.claude.json** — _File exists — no servers defined_
